...
const FilterableContent = () => {
  ...
  return (
    <Content className="z-50 overflow-hidden rounded-lg border border-zinc-200 bg-white shadow-2xl dark:border-zinc-700 dark:bg-zinc-900">
      <Input
        className="w-full border-zinc-200 border-b bg-transparent px-3 py-2 text-zinc-900 outline-none placeholder:text-zinc-400 dark:border-zinc-800 dark:text-zinc-100 dark:placeholder:text-zinc-600"
        placeholder="Search…"
        autoFocus
      />
      <div className="p-1">
        ...
        <Empty className="py-4 text-center text-zinc-400 dark:text-zinc-600">No results.</Empty>
      </div>
    </Content>
  )
}
